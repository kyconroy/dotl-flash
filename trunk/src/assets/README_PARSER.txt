...
"A" is a starting attack tower's location.  
...
"@" followed by some digits, followed by a space, followed by some letters.
...
Would spawn enemies 5 seconds after the last wave, and would spawn an
enemy of type "a" followed by another, followed by a third enemy of type "a"
followed by an enemy of type "b" followed by another of type "a".  
